...
- **Transferência de Arquivos**: Os clientes podem enviar arquivos de texto para todos os participantes da sala de bate-papo.
...
- O aplicativo suporta apenas o envio de arquivos de texto (formato `.txt`).
